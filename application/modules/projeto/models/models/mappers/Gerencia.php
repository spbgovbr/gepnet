    ...
    public function pesquisar($params, $paginator = false) {
       ...
       /* if (isset($params['statusreport'])) {
        ...
        if (isset($params['domstatusprojeto'])) {
            ...
            switch($params['domstatusprojeto']){ case "Proposto": $status = 1; break; case "Em Andamento": $status = 2;
            ...
            $sql.= " and proj.domstatusprojeto = {$status}";
        }
    ...
    public function getQtdeProjetosPorStatus($params)
    {
        ...
        $sql = " SELECT 
                 ...
                 FROM 
                    agepnet200.tb_projeto 
                WHERE  	
                    domstatusprojeto IN ($statusprojeto) ";
