    ...
    public function init()
    {
        ...
        ->setOptions(array(
            ...
            "elements" => array(
                ...
                'nomsolicitante' => array('text', array(
                        'label'        => 'Solicitante',
                        'required'     => true,
                ...
                'flaaprovada' => array('select', array(
                        'label'        => 'Aprovada?',
                        'required'     => false,
                        'filters'      => array('StringTrim','StripTags'),
                ...
                'desmudanca' => array('textarea', array(
                ...
                'despareceregp' => array('textarea', array(
                ...
                'desaprovadores' => array('textarea', array(
                        'label'        => '',
                        'required'     => false,
                        'filters'      => array('StringTrim','StripTags'),
                        'validators'   => array('NotEmpty',array('StringLength', false, array(0, 4000))),
                ...
                'despareceraprovadores' => array('textarea', array(
                ...
                'idtipomudanca' => array('select', array(
