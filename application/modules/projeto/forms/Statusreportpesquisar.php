                ...
                ->setOptions(array(
                    ...
                    "elements" => array(
                        ...
                        'idescritorio' => array('select', array(
                                ...
                                'required' => false,
                                'multiOptions' => 
                                array("Todos",$serviceEscritorio->fetchPairs()),
                        ...
                        'idprograma ' => array('select', array(
                                'label' => 'Programa',
                                'required' => false,
                                'multiOptions' => array("" => "Todos", $servicePrograma->fetchPairs()),
                                'filters' => array('StringTrim', 'StripTags'),
                                'validators' => array('NotEmpty'),
                                'attribs' => array(),
                            )),
...
//                                'filters' => array(),
                        'domstatusprojeto' => array('select', array(
                                'label' => 'Status',
                                'required' => false,
                                'multiOptions' => array($serviceSituacao->retornaNomeSituacaoAtivo()),
                                'filters' => array(),
                                'validators' => array(),
                                'attribs' => array(),
                            )),
...
//                                'attribs' => array(),
//                            )),
                        'codobjetivo' => array('select', array(
