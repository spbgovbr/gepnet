...
class Projeto_Form_ComunicacaoPesquisar extends App_Form_FormAbstract
{
    ...
    public function init()
    {
        $this->setOptions(array(
            ...
            "elements" => array(
                'idcomunicacaopesquisar' => array('text', array(
                ...
                'idprojetopesquisar' => array('hidden', array(
                        'filters' => array('StringTrim', 'StripTags'),
                        'validators' => array(array('StringLength', false, array(0, 15))),
                        'attribs' => array(
                            'class' => 'span3',
                ...
                'desinformacaopesquisar' => array('text', array(
                ...
                'desinformadopesquisar' => array('text', array(
                ...
                'desorigempesquisar' => array('text', array(
                        'label' => 'Qual a origem?',
                        'filters' => array('StringTrim', 'StripTags'),
                        'validators' => array(array('StringLength', false, array(0, 255))),
                        'attribs' => array(
                ...
                'desfrequenciapesquisar' => array('text', array(
                ...
                'destransmissaopesquisar' => array('text', array(
                ...
                'desarmazenamentopesquisar' => array('text', array(
...
//                        ),
//                    )),
                'idresponsavelpesquisar' => array('select', array(
                                'label' => 'Responsável:',
                                'required' => false,
                                'multiOptions' => array(),
                                'filters' => array('StringTrim', 'StripTags'),
