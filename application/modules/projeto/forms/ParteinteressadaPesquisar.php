    ...
    public function init() {
        $this->setOptions(array(
                    ...
                    "elements" => array(
                        ...
                        'nomparteinteressadapesquisar' => array('text', array(
                                'label' => 'Nome',
                        ...
                        'idparteinteressadapesquisar' => array('hidden', array(
                                'filters' => array('StringTrim', 'StripTags'),
                                'attribs' => array(
                                    'readonly' => true,
                                ),
                            )),
                        'nomfuncaopesquisar' => array('text', array(
                        ...
                        'dessituacaopesquisar' => array('text', array(
                                'label' => 'Situação',
                                'filters' => array('StringTrim', 'StripTags'),
                                'validators' => array(array('StringLength', false, array(0, 50))),
                                'attribs' => array(
                        ...
                        'destelefonepesquisar' => array('text', array(
                                'label' => 'Telefone',
                                'filters' => array('StringTrim', 'StripTags'),
                                'validators' => array(array('StringLength', false, array(0, 50))),
                                'attribs' => array(
                        ...
                        'desemailpesquisar' => array('text', array(
                                'label' => 'Email',
                                'filters' => array('StringTrim', 'StripTags'),
                                'validators' => array( 
                                    'EmailAddress',
                        ...
                        'domnivelinfluenciapesquisar' => array('select', array(
                        ...
                        'idcadastradorpesquisar' => array('select', array(
                                'label' => '',
                                'multiOptions' => array(),
                                'filters' => array('StringTrim', 'StripTags'),
                                'attribs' => array(),
                            )),
                        'datcadastropesquisar' => array('text', array(
                                'label' => '',
                                'filters' => array('StringTrim', 'StripTags'),
                                'attribs' => array(),
                            )),
