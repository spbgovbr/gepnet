        ...
        $this
                ...
                ->setOptions(array(
                    ...
                    "elements" => array(
                       ...
                       'tipoatividade'     => array('checkbox', array(
                            'label'      => 'Atividade',
                            'required'   => false,
                            'setCheckedValue' => 1,
                            'setUncheckedValue' => 0,
                       ...
                       'tipomarco'     => array('checkbox', array(
                            'label'      => 'Marco',
                            'required'   => false,
                            'setCheckedValue' => 1,
                            'setUncheckedValue' => 0,
                       ...
                       'tipogrupo'     => array('checkbox', array(
                            'label'      => 'Grupo',
                            'required'   => false,
                            'setCheckedValue' => 1,
                            'setUncheckedValue' => 0,
                        ...
                        'tipoentrega'     => array('checkbox', array(
                            'label'      => 'Entrega',
                            'required'   => false,
                            'setCheckedValue' => 1,
                            'setUncheckedValue' => 0,
                        ...
                        'statusatividade' => array('select', array(
                            'label'        => 'Status da Atividade',
                            'multiOptions' => array(    'T'  => 'Todas',
                                                        'A'  => 'Atrasada',
                                                        100 => 'Concluído',
                                                        50  => 'Em andamento', 
                                                        'C'  => 'Cancelada' ),
