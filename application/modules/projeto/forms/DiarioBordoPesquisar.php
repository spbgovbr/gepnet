...
class Projeto_Form_DiarioBordoPesquisar extends App_Form_FormAbstract
{
    ...
    public function init()
    {
        ...
        $arrReferencias = array(''=>'Todas', 
                                'Observação'=>'Observação', 
                                'Ponto de Atenção'=>'Ponto de Atenção', 
                                'Reunião'=>'Reunião'
            );
        $arrSemaforo = array(''=>'Todas', 
                                '1'=>'Vermelho', 
                                '2'=>'Amarelo', 
                                '3'=>'Verde'
            );
        ...
        $this->setOptions(array(
            ...
            'elements'=>array(
                        ...
                        'domreferencia' => array('select', array(
                                'label' => 'Referência',
                        ...
                        'datdiariobordo' => array('text', array(
                                'label' => 'Período',
                                //'readonly' => 'readonly',
                                'filters' => array('StringTrim', 'StripTags'),
                                ...
                                'attribs' => array(
                                    ...
                                    'id'=> 'datdiariobordoinicio', //evita conflito do datepicker em campos com mesmo id em forms diferentes
                                    'maxlength' => '10',
                        ...
                        'datdiariobordofim' => array('text', array(
                                'filters' => array('StringTrim', 'StripTags'),
                                'validators' => array('Date'),
                                'attribs' => array(
                                    'class' => 'span2 mask-date',
                                    'id'=> 'datdiariobordofim', //evita conflito do datepicker em campos com mesmo id em forms diferentes
                                    'maxlength' => '10',
                                    'data-rule-maxlength' => 10,
                                    'data-rule-dateITA' => true,
                                    'placeholder' => 'DD/MM/AAAA',
                        ...
                        'domsemafaro' => array('select', array(
                                'label' => 'Status',
                        ...
                        'desdiariobordo' => array('textarea', array(
                                'label' => 'Descrição',
                                'filters' => array('StringTrim', 'StripTags'),
