...
class Projeto_Service_AtividadeCronoPredecessora extends App_Service_ServiceAbstract
{
    ...
    /**
     *
     * @var Projeto_Model_Mapper_AtividadeCronoPredecessora
     */
    protected $_mapper;
    ...
    {
        $this->_mapper = new Projeto_Model_Mapper_AtividadeCronoPredecessora();
    }
    ...
    public function inserir($dados)
    {
        ...
        try {
            $model = new Projeto_Model_AtividadeCronoPredecessora($dados);
    ...
    public function retornaTodasPredecessorasPorIdAtividade($params, $atividade)
    {
        return $this->_mapper->retornaTodasPredecessorasPorIdAtividade($params, $atividade);
    }
