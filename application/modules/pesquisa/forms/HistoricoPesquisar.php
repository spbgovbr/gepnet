...
class Pesquisa_Form_HistoricoPesquisar extends App_Form_FormAbstract
{
    ...
    public function init()
    {
        ...
        $this->setOptions(array(
            ...
            'elements'=>array(
                        'nomquestionario' => array('text', array(
                        ...
                        'nome_publicou' => array('text', array(
                                'label' => 'Publicado por',
                                'filters' => array('StringTrim', 'StripTags'),
                                'attribs' => array(
                                    'class' => 'span3',
                        ...
                        'nome_encerrou' => array('text', array(
                                'label' => 'Encerrado por',
                                'filters' => array('StringTrim', 'StripTags'),
                                'attribs' => array(
                                    'class' => 'span3',
                        ...
                        'datencerramento' => array('text', array(
                                'filters' => array('StringTrim', 'StripTags'),
