...
class Planejamento_Model_Mapper_Portfolio extends App_Model_Mapper_MapperAbstract
{
        ...
        try {
            ...
            if( count($model->idprograma) > 0){
                ...
                foreach($model->idprograma as $programa){
                    $modelPortProg = new Planejamento_Model_Portfolioprograma(array('idportfolio' => $model->idportfolio,
                                                                                    'idprograma' => $programa));
    ...
    public function update(Planejamento_Model_Portfolio $model)
    {
        ...
        try {
            ...
            $modelPortP = new Planejamento_Model_Portfolioprograma(array( 'idportfolio' => $model->idportfolio,
