...
class Acordocooperacao_Form_Acordo extends App_Form_FormAbstract
{
        ...
        $this
            ...
            ->setOptions(array(
                ...
                "elements" => array(
                    ...
                    'idacordopai'                   => array('select', array(
...
//                        )),
                    ...
                    'idresponsavelinterno' => array('hidden', array(
//                        'label' => 'Responsável Interno',
                    ...
                    'nomresponsavelinterno' => array('text', array(
                        'label' => 'Responsável Interno',
                        'required' => true,
                        'filters' => array('StringTrim', 'StripTags'),
                        'validators' => array('NotEmpty',array('StringLength', false, array(0, 100))),
                    ...
                    'destelefoneresponsavelinterno' => array('text', array(
                    ...
                    'entidadeexterna' => array('select', array(
...
//                        'multiOptions'  => $mapperEntidadeExterna->fetchPairs(),
                    ...
                    'destelefonefiscal'             => array('text', array(
                    ...
                    'despalavrachave'=> array('text', array(
                        'label'      => 'Palavra Chave',
                        'required'   => false,
                        'filters'    => array('StringTrim', 'StripTags'),
                    ...
                    'desobjeto'      => array('textarea', array(
                        'label'      => 'Objeto',
                        'required'   => true,
                        'filters'    => array('StringTrim', 'StripTags'),
                        'validators' => array(array('StringLength', false, array(0, 4000))),
                    ...
                    'desobservacao'  => array('textarea', array(
                        'label'      => 'Observações',
                        'required'   => false,
                        'filters'    => array('StringTrim', 'StripTags'),
                        'validators' => array(array('StringLength', false, array(0, 4000))),
                    ...
                    'numprazovigencia'=> array('text', array(
                        'label'      => 'Prazo (dias)',
                        'required'   => false,
                        'filters'    => array('StringTrim', 'StripTags'),
                        'validators' => array(),
                    ...
                    'datassinatura'  => array('text', array(
                    ...
                    'datiniciovigencia'=> array('text', array(
                    ...
                    'datfimvigencia' => array('text', array(
                    ...
                    'datatualizacao' => array('text', array(
                        'label'      => '',
                        'required'   => false,
                        'filters'    => array('StringTrim', 'StripTags'),
                        'validators' => array(),
                    ...
                    'datpublicacao'  => array('text', array(
                    ...
                    'flarescindido'  => array('select', array(
                        'label'      => 'Rescindido?',
                        'required'   => true,
                    ...
                    'flasituacaoatual'  => array('select', array(
                        'label'         => 'Situação',
                        'required'      => false,
                    ...
                    'descontatoexterno'=> array('textarea', array(
                    ...
                    'descargofiscal' => array('text', array(
...
//                array('Extension', false, 'txt,doc,docx,pdf')
        ...
        $this->addElement('file', 'descaminho', array(
            ...
            //'MultiFile' => 3,
            'destination' => APPLICATION_PATH . DIRECTORY_SEPARATOR . "data" . DIRECTORY_SEPARATOR .'acordo',
            'description' => 'São aceitas as extensões: doc,docx,pdf. Tamanho Máximo: 32MB   ',
            'attribs'     => array(
                'class'              => 'span4',
                'data-rule-required' => false,
            ),
