 ...
 */
class Evento_Form_AvaliacaoServidor extends App_Form_FormAbstract
{
    ...
    public function init()
    {
        ...
        $this
           ...
           'nomavaliado' => array('text', array(
            ...
            'nomavaliador' => array('text', array(
                'label'        => 'Nome Avaliador',
                'required'     => false,
                'filters'      => array('StringTrim','StripTags'),
                'validators'   => array('NotEmpty'),
                'attribs'      => array('data-rule-required' => false)
            )),
          'numnotaavaliador' => array('select', array(
            ...
            'idtipoavaliacao' => array('select', array(
