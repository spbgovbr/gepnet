...
class Processo_Form_Processo extends App_Form_FormAbstract
{
    ...
    public function init()
    {
        ...
        //$pessoaFetchPairs = $servicePessoa->fetchPairs();
        /*
        $pessoaButton = $this->createElement('button', 'pessoaButton', array(
            'label'        => '',
            'ignore'       => true,
            'icon'         => 'user',
        ...
        $pessoaButton
          ...
          $nomdono     = $this->createElement('text', 'nomdono', array(
          'label' => '',
          'ignore'       => true,
          //'append'    => $pessoaButton,
          //'label' => 'Limpar',
        ...
        $this->setOptions(array(
            ...
            "elements" => array(
                ...
                'idprocessopai'  => array('select', array(
                        'label'        => 'Processo Pai',
                        'required'     => false,
                ...
                'desprocesso'    => array('textarea', array(
                        'label'      => 'Descrição',
                        'required'   => false,
                        'filters'    => array('StringTrim', 'StripTags'),
                        'validators' => array('NotEmpty', array('StringLength', false, array(0, 100))),
                ...
                'idconsultor'    => array('hidden', array(
                        //'label'        => 'Consultor',
                        'required'   => true,
                        //'append' => $pessoaButton,
                        'filters'    => array('StringTrim', 'StripTags'),
