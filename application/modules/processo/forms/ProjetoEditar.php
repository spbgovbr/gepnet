 ...
 */
class Processo_Form_ProjetoEditar extends App_Form_FormAbstract
{
    ...
    public function init()
    {
        ...
        $this->setOptions(array(
            ...
            "elements" => array(
                ...
                'domsituacao'        => array('select', array(
                        'label'        => 'Situação',
                        'required'     => true,
                ...
                'desprojetoprocesso' => array('textarea', array(
                        'label'      => 'Descrição',
                        'required'   => false,
                        'filters'    => array('StringTrim', 'StripTags'),
