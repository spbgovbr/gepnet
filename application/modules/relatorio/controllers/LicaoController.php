...
class Relatorio_LicaoController extends Zend_Controller_Action
{

    public function indexAction()
    {
        $service = App_Service_ServiceAbstract::getService('Relatorio_Service_Licao');
    ...
    public function imprimirPdfAction()
    {
        ...
        $html = $this->view->render('/_partials/licao-imprimir-pdf.phtml');
        $this->_helper->layout->disableLayout();
