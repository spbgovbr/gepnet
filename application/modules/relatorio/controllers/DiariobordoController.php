...
class Relatorio_DiariobordoController extends Zend_Controller_Action
{

    public function indexAction()
    {
        $service = App_Service_ServiceAbstract::getService('Relatorio_Service_Diariobordo');
    ...
    public function imprimirPdfAction()
    {
        ...
        $html = $this->view->render('/_partials/diario-imprimir-pdf.phtml');
        $this->_helper->layout->disableLayout();
