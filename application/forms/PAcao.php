 ...
 */
class Default_Form_PAcao extends App_Form_FormAbstract
{

    public function init()
    {
        $mapperTbProjetoprocesso = new Default_Model_Mapper_TbProjetoprocesso();
        ...
        'idprojetoprocesso' => array('select', array(
                'label'        => '',
                'required'     => true,
                'multiOptions' => $mapperTbProjetoprocesso->fetchPairs(), 
