 ...
 */
class Default_Form_Agenda extends App_Form_FormAbstract
{
    ...
    public function init()
    {
        ...
        'desagenda' => array('textarea', array(
                'label'        => '',
                'required'     => false,
                'filters'      => array('StringTrim','StripTags'),
        ...
        'flaenviaemail' => array('text', array(
                'label'        => '',
                'required'     => false,
                'filters'      => array('StringTrim','StripTags'),
