...
class Default_Form_PerfilLogin extends App_Form_FormAbstract
{
    ...
    public function init()
    {
        ...
        //$servicoPerfil = new Default_Service_Perfil();
        //$usuario->idpessoa = 11; //GRSF
        
        //$perfis = $service->retornaPorPessoa(array('idpessoa' => $usuario->idpessoa));
        //Zend_Debug::dump($perfis);exit;
