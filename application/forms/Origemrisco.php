 ...
 */
class Default_Form_Origemrisco extends App_Form_FormAbstract
{
        ...
        $mapperTbPessoa = new Default_Model_Mapper_TbPessoa();
                            $this
                                ->setOptions(array(
                                    "method"   => "post",
                                    "elements" => array(
                                        'idorigemrisco' => array('hidden', array()),
        'desorigemrisco' => array('text', array(
                'label'        => '',
                'required'     => false,
