 ...
 */
class Default_Form_Frase extends App_Form_FormAbstract
{
        ...
        $mapperTbPessoa = new Default_Model_Mapper_TbPessoa();
                            $this
                                ->setOptions(array(
                                    "method"   => "post",
                                    "elements" => array(
                                        'idfrase' => array('hidden', array()),
        'idfrasepai' => array('select', array(
                'label'        => '',
                'required'     => false,
