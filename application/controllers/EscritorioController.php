...
class EscritorioController extends Zend_Controller_Action
{
    ...
    public function editarAction()
    {
        ...
        if ($this->_request->isPost()) {
            if ($this->_request->isXmlHttpRequest()) {
                ...
                if ($success) {
                    $this->_helper->_redirector->gotoSimpleAndExit('editar', 'escritorio', 'default',
    ...
    {
        $mapper = new Default_Model_Mapper_Escritorio();
    ...
    {
        $form = new Default_Form_EscritorioPesquisar();
        /*
        if($this->_request->isPost()) {
