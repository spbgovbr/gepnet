...
class Default_Service_Programa extends App_Service_ServiceAbstract
{
    ...
    {
        $this->_mapper = new Default_Model_Mapper_Programa();
    }
    ...
    {
        return $this->_mapper->fetchPairsProgramaSemPortfolio();
    }
