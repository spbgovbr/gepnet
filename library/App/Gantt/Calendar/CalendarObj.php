...
class App_Gantt_Calendar_CalendarObj
{
    ...
    function year($year = false)
    {
        ...
        return new App_Gantt_Calendar_CalendarYear($year, 1, 1, 0, 0, 0);
    }
    ...
    function month($month = false)
    {
        ...
        return new App_Gantt_Calendar_CalendarMonth($this->yearINT, $month, 1, 0, 0, 0);
    }
    ...
    function day($day = false)
    {
        ...
        return new App_Gantt_Calendar_CalendarDay($this->yearINT, $this->monthINT, $day, 0, 0, 0);
    }
    ...
    function hour($hour = false)
    {
        ...
        return new App_Gantt_Calendar_CalendarHour($this->yearINT, $this->monthINT, $this->dayINT, $hour, 0, 0);
    }
    ...
    function minute($minute = false)
    {
        ...
        return new App_Gantt_Calendar_CalendarMinute($this->yearINT, $this->monthINT, $this->dayINT, $this->hourINT,
            $minute, 0);
    }
    ...
    function second($second = false)
    {
        ...
        return new App_Gantt_Calendar_CalendarSecond($this->yearINT, $this->monthINT, $this->dayINT, $this->hourINT,
            $this->minuteINT, $second);
    }
    ...
    function modify($string)
    {
        ...
        return new App_Gantt_Calendar_CalendarDay($year, $month, $day, $hour, $minute, $second);
    }
