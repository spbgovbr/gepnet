...
class indic
{
    ...
    function substituteIndic($earr, $lang, $font)
    {
        ...
        if ($lang == 'hi') {
            ...
            $vstr = preg_replace('/([A-F0-9]{4}) ' . $prebasedvowels . ' ' . $nukta . '/', '\\2 \\1 ' . $nukta,
                $vstr);    // before NUKTA
            $vstr = preg_replace('/([A-F0-9]{4}) ' . $halant . ' ' . $prebasedvowels . '/', '\\2 \\1 ' . $halant,
                $vstr);    // before CHAR HALANT  ==  VIRAMA
                ...
                if ($lang == 'gu') {
                    ...
                    if ($lang == 'pa') {
                        ...
                        if ($lang == 'ta') {
                            ...
                            $vstr = preg_replace('/0B95 ' . $halant . ' ' . $prebasedvowels . ' 0BB7/',
                                '\\1 0B95 ' . $halant . ' 0BB7', $vstr);
                        } // ORIYA
                        else {
                            if ($lang == 'or') {
                                ...
                                // No nukta
                                $halant = "0B4D";
                                $vstr = preg_replace('/([A-F0-9]{4}) ' . $orprebasedvowels . '/', '\\2 \\1',
                                    $vstr);    // vowel sign pre-based shift left
                                $vstr = preg_replace('/([A-F0-9]{4}) ' . $halant . ' ' . $orprebasedvowels . '/',
                                    '\\2 \\1 ' . $halant, $vstr);    // before CHAR HALANT
                                $vstr = preg_replace('/([A-F0-9]{4}) ' . $halant . ' ' . $orprebasedvowels . '/',
                                    '\\2 \\1 ' . $halant, $vstr);    // before CHAR HALANT
                            } // MALAYALAM
                                ...
                                if ($lang == 'ml') {
                                    ...
                                    */
                                    ...
                                    // No nukta
                                    $halant = "0D4D";
                                    $vstr = preg_replace('/([A-F0-9]{4}) ' . $mlprebasedvowels . '/', '\\2 \\1',
                                        $vstr);    // vowel sign pre-based shift left
                                    ...
                                    if ($lang == 'te') {
                                        ...
                                        $vstr = preg_replace('/(' . $tefullforms . ') ' . $halant . ' (' . $tefullforms . ') ' . $abvvowels . '/',
                                            '\\1 \\3 ' . $halant . ' \\2', $vstr);    // before HALANT
                                    } // KANNADA
                                    else {
                                        if ($lang == 'kn') {
...
//echo $vstr.'<br />'; exit;
        ...
        if ($lang == 'kn') {
            ...
            for ($i = 0; $i < count($knbase); $i++) {
                $vstr = preg_replace('/' . $knbase[$i] . ' (' . $belowbase1 . ') (' . $belowbase2 . ') ' . $matraI . '/',
                    $knmatraIligature[$i] . ' \\1 \\2', $vstr);
                $vstr = preg_replace('/' . $knbase[$i] . ' (' . $belowbase1 . ') ' . $matraI . '/',
        ...
        if ($lang == 'hi') {
            ...
            $vstr = preg_replace('/E015 (0940|E194|E195|E196|E197|E198)/', '\\1 E014',
                $vstr);    // (Small) reph [E014] to Right of matraI
            ...
            if ($lang == 'bn') {
                ...
                if ($lang == 'gu') {
                    ...
                    if ($lang == 'te') {
                        ...
                        $vstr = preg_replace('/(' . $tefullforms . '|' . $matraligs . ') (E046|E069|E077)/', '\\2 \\1',
                            $vstr);
                        ...
                        if ($lang == 'kn') {
                            ...
                            if ($lang == 'or') {
                                ...
                                $vstr = preg_replace('/(' . $orfullforms . ') E06D (' . $orfullforms . ') 0B3E/',
                                    '\\1 0B3F E069 \\2 0B3E', $vstr);


                                while (preg_match('/(' . $orrephs . ') (' . $orpartialforms . ')/', $vstr)) {
                                    $vstr = preg_replace('/(' . $orrephs . ') (' . $orpartialforms . ')/', '\\2 \\1',
                                        $vstr);
                                }
                                ...
                                if ($lang == 'ml') {
                                    $halant = "0D4D";
                                    $vstr = preg_replace('/([A-F0-9]{4}) ' . $halant . ' 0D30/', 'E00E \\1',
                                        $vstr);    // 0D30 = Ra
                                    $vstr = preg_replace('/([A-F0-9]{4}) ' . $halant . ' ' . $mlprebasedvowels . ' 0D30/',
                                        '\\2 E00E \\1', $vstr);    // 0D30 = Ra
