...
class OdoGraph extends Graph
{
    ...
    function PushColor($sColor = "")
    {
        $this->img->PushColor($sColor);
    }

    function SetFont($sFamily = "", $sStyle = "", $sSize = 10)
    {
        $this->img->SetFont($sFamily, $sStyle, $sSize);
    }

    function SetTextAlign($sHalign, $sValign = "bottom")
    {
        $this->img->SetTextAlign($sHalign, $sValign);
    }

    function StrokeText($sX, $sY, $sTxt, $sDir = 0, $sParagraph_align = "left", $sDebug = false)
    {
        $this->img->StrokeText($sX, $sY, $sTxt, $sDir, $sParagraph_align, $sDebug);
    }
