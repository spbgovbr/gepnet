...
class Zend_Service_Amazon_Offer
{
    ...
    public function __construct(DOMElement $dom)
    {
        ...
        $this->OfferListingId = (string)$xpath->query('./az:OfferListing/az:OfferListingId/text()',
            $dom)->item(0)->data;
        ...
        if ($Price->length == 1) {
            ...
            $this->CurrencyCode = (string)$xpath->query('./az:OfferListing/az:Price/az:CurrencyCode/text()',
                $dom)->item(0)->data;
        }
