    ...
    public function signRequestHeaders(
        ...
        if ($headers !== null) {
            foreach ($headers as $header => $value) {
                ...
                if (substr($header, 0,
                        strlen(Zend_Service_WindowsAzure_Credentials_CredentialsAbstract::PREFIX_STORAGE_HEADER)) == Zend_Service_WindowsAzure_Credentials_CredentialsAbstract::PREFIX_STORAGE_HEADER) {
