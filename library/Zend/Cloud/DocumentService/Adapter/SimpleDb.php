    ...
    extends Zend_Cloud_DocumentService_Adapter_AbstractAdapter
{
    ...
    public function createCollection($name, $options = null)
    {
        try {
            ...
            throw new Zend_Cloud_DocumentService_Exception('Error on domain creation: ' . $e->getMessage(),
                $e->getCode(), $e);
        }
    }
    ...
    public function fetchDocument($collectionName, $documentId, $options = null)
    {
        try {
            ...
            throw new Zend_Cloud_DocumentService_Exception('Error on fetching document: ' . $e->getMessage(),
                $e->getCode(), $e);
        }
    }
