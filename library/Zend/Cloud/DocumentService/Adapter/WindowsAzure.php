    ...
    extends Zend_Cloud_DocumentService_Adapter_AbstractAdapter
{
    ...
    public function __construct($options = array())
    {
        ...
        try {
            ...
            throw new Zend_Cloud_DocumentService_Exception('Error on document service creation: ' . $e->getMessage(),
                $e->getCode(), $e);
        }
    }
    ...
    public function createCollection($name, $options = null)
    {
        ...
        try {
            ...
            if (strpos($e->getMessage(), "table specified already exists") === false) {
                throw new Zend_Cloud_DocumentService_Exception('Error on collection creation: ' . $e->getMessage(),
                    $e->getCode(), $e);
            }
        }
        return true;
    ...
    public function deleteCollection($name, $options = null)
    {
        try {
            ...
            if (strpos($e->getMessage(), "does not exist") === false) {
                throw new Zend_Cloud_DocumentService_Exception('Error on collection deletion: ' . $e->getMessage(),
                    $e->getCode(), $e);
            }
        }
        return true;
    ...
    public function listCollections($options = null)
    {
        try {
            ...
            throw new Zend_Cloud_DocumentService_Exception('Error on collection list: ' . $e->getMessage(),
                $e->getCode(), $e);
        }
    ...
    public function insertDocument($collectionName, $document, $options = null)
    {
        ...
        try {
            ...
            throw new Zend_Cloud_DocumentService_Exception('Error on document insertion: ' . $e->getMessage(),
                $e->getCode(), $e);
        }
    }
    ...
    public function replaceDocument($collectionName, $document, $options = null)
    {
        ...
        try {
            ...
            throw new Zend_Cloud_DocumentService_Exception('Error on document replace: ' . $e->getMessage(),
                $e->getCode(), $e);
        }
    }
    ...
    public function updateDocument($collectionName, $documentId, $fieldset = null, $options = null)
    {
        ...
        try {
            ...
            throw new Zend_Cloud_DocumentService_Exception('Error on document update: ' . $e->getMessage(),
                $e->getCode(), $e);
        }
    }
    ...
    public function deleteDocument($collectionName, $documentId, $options = null)
    {
        ...
        try {
            ...
            if (strpos($e->getMessage(), "does not exist") === false) {
                throw new Zend_Cloud_DocumentService_Exception('Error on document deletion: ' . $e->getMessage(),
                    $e->getCode(), $e);
            }
        }
    }
    ...
    public function fetchDocument($collectionName, $documentId, $options = null)
    {
        ...
        try {
            ...
            throw new Zend_Cloud_DocumentService_Exception('Error on document fetch: ' . $e->getMessage(),
                $e->getCode(), $e);
        }
    }
    ...
    public function query($collectionName, $query, $options = null)
    {
        try {
            ...
            throw new Zend_Cloud_DocumentService_Exception('Error on document query: ' . $e->getMessage(),
                $e->getCode(), $e);
        }
