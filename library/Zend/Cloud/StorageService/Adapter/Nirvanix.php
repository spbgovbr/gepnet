...
//                // TODO Differentiate among errors in the Nirvanix adapter
    ...
    public function fetchMetadata($path, $options = null)
    {
        ...
        try {
            ...
            throw new Zend_Cloud_StorageService_Exception('Error on fetching metadata: ' . $e->getMessage(),
                $e->getCode(), $e);
        }
    ...
    public function storeMetadata($destinationPath, $metadata, $options = null)
    {
        ...
        if ($metadata != null) {
            try {
                ...
                throw new Zend_Cloud_StorageService_Exception('Error on storing metadata: ' . $e->getMessage(),
                    $e->getCode(), $e);
            }
        }
    }
    ...
    public function deleteMetadata($path, $metadata = null, $options = null)
    {
        ...
        try {
            ...
            throw new Zend_Cloud_StorageService_Exception('Error on deleting metadata: ' . $e->getMessage(),
                $e->getCode(), $e);
        }
    }
