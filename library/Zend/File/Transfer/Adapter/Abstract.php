...
abstract class Zend_File_Transfer_Adapter_Abstract
{
    ...
    public function setPluginLoader(Zend_Loader_PluginLoader_Interface $loader, $type)
    {
        ...
        switch ($type) {
            ...
            default:
                require_once 'Zend/File/Transfer/Exception.php';
                throw new Zend_File_Transfer_Exception(sprintf('Invalid type "%s" provided to setPluginLoader()',
                    $type));
        }
    }
    ...
    public function getPluginLoader($type)
    {
        ...
        switch ($type) {
            ...
            default:
                require_once 'Zend/File/Transfer/Exception.php';
                throw new Zend_File_Transfer_Exception(sprintf('Invalid type "%s" provided to getPluginLoader()',
                    $type));
        }
    }
        ...
        if (is_array($files)) {
            foreach ($files as $find) {
                ...
                if (empty($found)) {
                    ...
                    require_once 'Zend/File/Transfer/Exception.php';
                    throw new Zend_File_Transfer_Exception(sprintf('The file transfer adapter can not find "%s"',
                        $find));
                }
