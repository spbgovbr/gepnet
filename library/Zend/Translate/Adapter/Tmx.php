                        ...
                        if (Zend_Locale::isLocale($attrib['srclang'])) {
                            ...
                            if (!$this->_options['disableNotices']) {
                                if ($this->_options['log']) {
                                    ...
                                    trigger_error("The language '{$attrib['srclang']}' can not be set because it does not exist.",
                                        E_USER_NOTICE);
                                }
                            }
                        ...
                        if (Zend_Locale::isLocale($attrib['xml:lang'])) {
                            ...
                            if (!$this->_options['disableNotices']) {
                                if ($this->_options['log']) {
                                    ...
                                    trigger_error("The language '{$attrib['xml:lang']}' can not be set because it does not exist.",
                                        E_USER_NOTICE);
                                }
                            }
