...
$MyData = new pData();
$MyData->createFunctionSerie("Serie 1", "log(z)", array(
...
$MyData->createFunctionSerie("Serie 2", "z*z*z",
    array("AutoDescription" => true, "MinX" => -10, "MaxX" => 10, "XStep" => 1));
$MyData->createFunctionSerie("Serie 3", "(z*15)*z",
    array("AutoDescription" => true, "MinX" => -10, "MaxX" => 10, "XStep" => 1));
...
$myPicture->drawGradientArea(540, 0, 700, 30, DIRECTION_VERTICAL,
