...
$myPicture->drawArrowLabel(139, 128, "TEXT_ALIGN_BOTTOMLEFT",
    array("Length" => 20, "Angle" => 135, "RoundPos" => true));

$myPicture->drawArrowLabel(260, 75, "TEXT_ALIGN_TOPMIDDLE", array("Length" => 20, "Angle" => 45, "RoundPos" => true));
$myPicture->drawArrowLabel(260, 101, "TEXT_ALIGN_MIDDLEMIDDLE",
    array("Length" => 90, "Angle" => 315, "RoundPos" => true));
$myPicture->drawArrowLabel(260, 128, "TEXT_ALIGN_BOTTOMMIDDLE",
...
$myPicture->drawArrowLabel(395, 101, "TEXT_ALIGN_MIDDLERIGHT",
    array("Length" => 20, "Angle" => 270, "RoundPos" => true));
$myPicture->drawArrowLabel(395, 128, "TEXT_ALIGN_BOTTOMRIGHT",
    array("Length" => 20, "Angle" => 225, "RoundPos" => true));
