...
$PieChart->draw2DPie(560, 125, array(
...
$myPicture->drawText(120, 200, "Single AA pass",
    array("DrawBox" => true, "BoxRounded" => true, "R" => 0, "G" => 0, "B" => 0, "Align" => TEXT_ALIGN_TOPMIDDLE));
$myPicture->drawText(440, 200, "Extended AA pass / Splitted",
    array("DrawBox" => true, "BoxRounded" => true, "R" => 0, "G" => 0, "B" => 0, "Align" => TEXT_ALIGN_TOPMIDDLE));

/* Write the legend box */
$myPicture->setFontProperties(array(
    "FontName" => "../fonts/Silkscreen.ttf",
    "FontSize" => 6,
    "R" => 255,
    "G" => 255,
    "B" => 255
