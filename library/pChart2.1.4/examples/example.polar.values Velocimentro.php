...
$MyData = new pData();
$MyData->addPoints(array(10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10), "ScoreA");
$MyData->setSerieDescription("ScoreA", "Application A");

/* Define the absissa serie */
$MyData->addPoints(array("60", "70", "80", "90", "100", "110", "120", "130", "140", "0", "10", "20", "30", "40", "50"),
    "Labels");
...
$PieChart->draw2DPie(160, 140,
    array("DrawLabels" => true, "LabelStacked" => false, "Border" => true, "AxisRotation" => 180));
