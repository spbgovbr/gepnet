...
$myPicture->drawGradientArea(0, 0, 700, 20, DIRECTION_VERTICAL,
...
$myPicture->drawText(10, 13, "drawThresholdArea() - draw treshold areas in the charting area",
...
$myPicture->drawFilledRectangle(70, 70, 440, 180,
...
$myPicture->drawThresholdArea(0, 100,
...
$myPicture->drawFilledRectangle(505, 65, 665, 185,
    array("R" => 255, "G" => 255, "B" => 255, "Surrounding" => -200, "Alpha" => 10));
...
$myPicture->setShadow(true, array("X" => 1, "Y" => 1));
$myPicture->setFontProperties(array("FontName" => "../fonts/MankSans.ttf", "FontSize" => 10));
$myPicture->drawThresholdArea(5, 15, array(
    "NameR" => 0,
    "NameG" => 0,
    "NameB" => 0,
    "AreaName" => "Test Zone",
