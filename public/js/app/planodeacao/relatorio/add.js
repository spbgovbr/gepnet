$(function () {
    ...
    url_cadastrar = base_url + "/planodeacao/relatorio/add/format/json";

    $form.validate({
        errorClass: 'error',
        validClass: 'success',
//        submitHandler: function(form) {
//            enviar_ajax("/planodeacao/relatorio/add/format/json", "form#form-status-report", function(data) {
////                if (data.success) {
////                    window.location.href = base_url + "/planodeacao/relatorio/index/idplanodeacao/" + data.idplanodeacao;
////                }
//            });
//        }
        submitHandler: function (form) {
