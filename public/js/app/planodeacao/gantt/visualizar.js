$(function () {
    ...
    $("body").delegate("#resetbutton", "click", function (event) {
        ...
        //var options = $("#idgrupo");
        //options.find('option[value=""]').attr('selected', 'selected');
        //form.find('select[id="idgrupo"]').val("");
    ...
    $('#idgrupo').change(function (e) {
        ...
        var optionsMa = $("#idatividademarco");
        lista_atividade("", valor, 4, optionsMa);
    });
    $('#identrega').change(function (e) {
        ...
        var optionsMa = $("#idatividademarco");
        lista_atividade(valor, "", 4, options);
    });
    /******************************************************************************/
    ...
    //$('#idgrupo').find('option[value=' + grupoCons + ']').attr('selected', 'selected');
    //$('#identrega').find('option[value=' + entregaCons + ']').attr('selected', 'selected');
    //$('#idatividadecronograma').find('option[value=' + idativida_cons + ']').attr('selected', 'selected');
    //$('#idatividademarco').find('option[value=' + idamarco_cons + ']').attr('selected', 'selected');
    //alert(grupoCons);
    //alert(entregaCons);
    //alert(idativida_cons);
    //alert(idamarco_cons);
