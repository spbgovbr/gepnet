...
$(function () {
    ...
    actions = {
        detalhar: {
            ...
            url: base_url + '/projeto/gerencia/listapermissao',
            dialog: $('#dialog-detalhar')
        },
        editar: {
            form: $("form#form-permissao"),
            url: base_url + '/projeto/gerencia/editapermissao',
    ...
    chkchange = function (chkitem, icon, idrecurso, idpermissao) {
        ...
        idprojeto = $("#dialog-editar").find('input[name="idprojeto"]').val();
        idpessoa = $("#dialog-editar").find('input[name="idpessoa"]').val();
        urlper = base_url + "/projeto/gerencia/atualizapermissao";
    ...
    renderPermissaoEditar = function (name, idrecurso) {
        idparteinteressada = $("#dialog-editar").find('input[name="idparteinteressada"]').val()
        idprojeto = $("#dialog-editar").find('input[name="idprojeto"]').val()
        urlper = base_url + "/projeto/gerencia/editapermissao"
        $.ajax({
            url: urlper,
            dataType: 'html',
            type: 'POST',
            cache: true,
            data: {idprojeto: idprojeto, idparteinteressada: idparteinteressada, idrecurso: idrecurso,},
            success: function (data) {
    ...
    renderPermissaoDetalhar = function (name, idrecurso) {
        ...
        idprojeto = $("#dialog-detalhar").find('input[name="idprojeto"]').val()
        urlper = base_url + "/projeto/gerencia/listapermissao"
        $.ajax({
            url: urlper,
            dataType: 'html',
            type: 'POST',
