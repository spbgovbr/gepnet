...
//        console.log(r[16]);
        ...
        $return =   '<a target="_blank" class="btn actionfrm detalhar" title="Imprimir PLANO DE PROJETO" data-id="' + cellvalue + '" href="' + url.imprimir_plano + params + '"><i class="icon-print"></i></a>' +
                    ...
                    '<a target="_self" class="btn actionfrm editar" title="Projeto" data-id="' + cellvalue + '" href="' + url.projeto + params + '"><i class="icon-wrench"></i></a>';
...
//        console.log(r[16]);
        if(r[16]){
            $return += '<a data-target="#dialog-desbloquear" class="btn actionfrm desbloquear" title="Desbloquear" data-id="' + cellvalue + '" href="' + url.desbloqueio + params + '"><i class="icon-lock"></i></a>';
        }
...
//      return '<img src="' + path + '" />';
    ...
    colNames = ['Programa', 'Projeto', 'Gerente', 'Codigo', 'Publicado', 'Início', 'Término Meta', 'Termino Tendencia', 'Previsto', 'Concluído', 'Atraso', 'Prazo', 'Risco', 'Últim. Acompanhamento', 'Operações'];
    colModel = [
        {
            name: 'nomprograma',
            index: 'nomprograma',
