...
var
    ...
    function formatadorLink(cellvalue, options, rowObject)
    {
        ...
        params = '/idaceite/' + r[6] + '/idprojeto/' +r[8];
    ...
    colNames = ['Entrega Associada', 'Critério de Aceitação', 'Responsável', 'Produto ou Serviço Entregue', 'Parecer Final', 'Aceite','Operações'];
    colModel = [{
    ...
    $('body').on('change', '#aceito',  function() {
        if($(this).val() == 'S'){
            $.pnotify({
