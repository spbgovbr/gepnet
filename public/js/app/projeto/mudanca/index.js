    ...
    $dialogEditar.dialog({
        ...
        open: function(event, ui) {
            $(formEditar).validate({
                ...
                validClass: 'success',
                submitHandler: function(form) {
                        enviar_ajax("/projeto/solicitacaomudanca/editar/format/json", formEditar, function() {
                        grid.trigger("reloadGrid");
                    });
                }
            });
    ...
    $dialogCadastrar.dialog({
        ...
        open: function(event, ui) {
            $(formCadastrar).validate({
                ...
                validClass: 'success',
                submitHandler: function(form) {
                        enviar_ajax("/projeto/solicitacaomudanca/add/format/json", formCadastrar, function() {
                        grid.trigger("reloadGrid");
                    });
                }
            });
