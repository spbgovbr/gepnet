$(function () {
    ...
    var
        ...
        actions = {
            pesquisar: {
                ...
                url: base_url + "/diagnostico/pesquisaservidores/buscaquestionariovinculado?tpquestionario=1&"
            },
            vincular: {
                form: $("form#form-vincular"),
                url: base_url + "/diagnostico/pesquisaservidores/vincularquestionario/format/json"
            },
            responder: {
                form: $("form#form-responder"),
                url: base_url + "/diagnostico/pesquisaservidores/responderquestionario/format/json"
            },
            listagem: {
                //form : $("form#form-responder"),
                url: base_url + "/diagnostico/pesquisaservidores/buscaquestionariovinculado/tpquestionario/1/iddiagnostico/" + iddiagnostico
            }
        },
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.msg.type == 'success') {
                            $.pnotify(data.msg);
                            window.location.href = base_url + "/diagnostico/pesquisaservidores/listarquestionario/tpquestionario/1/iddiagnostico/" + iddiagnostico;
                        } else {
    ...
    function formatadorLink(cellvalue, options, rowObject) {
        ...
        var r = rowObject,
            ...
            linkEditar = '',
            url = {
                responder: base_url + '/diagnostico/pesquisaservidores/gerarnumeroquestionario'
            };
        params = '/idquestionariodiagnostico/' + r[1] + '/iddiagnostico/' + r[2] + '/tpquestionario/1';
    ...
    colNames = ['Nome do Questionário', 'idquestionario', 'iddiagnostico'];
    colModel = [
        {
    ...
    grid = jQuery("#list-grid").jqGrid({
        caption: "Listagem de Questionarios Vinculados dos Servidores",
