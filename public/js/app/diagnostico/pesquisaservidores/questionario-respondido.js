$(function () {
    ...
    var
        ...
        actions = {
            pesquisar: {
                ...
                url: base_url + "/diagnostico/pesquisaservidores/buscaquestionariorespondido?"
            },
            listagem: {
                url: base_url + "/diagnostico/pesquisaservidores/buscaquestionariorespondido/tpquestionario/1/iddiagnostico/" + iddiagnostico
            }
        },
    ...
    function formatadorLink(cellvalue, options, rowObject) {
        ...
        var r = rowObject,
            ...
            linkEditar = '',
            url = {
                visualizar: base_url + '/diagnostico/pesquisaservidores/visualizarquestionariorespondido'
            };
        params = '/idquestionariodiagnostico/' + r[3] + '/iddiagnostico/' + iddiagnostico + '/numero/' + r[1] + '/tpquestionario/1';
    ...
    grid = jQuery("#list-grid-respondido").jqGrid({
        caption: "Listagem de Questionarios Respodidos dos Servidores",
